...
export async function PATCH(request: NextRequest, { params }: { params: { id: string; sessionId: string } }) {
  try {
    const res = await fetch(`${COACHING_SERVICE}/programmes/${params.id}/sessions/${params.sessionId}`, {
