...
--
-- Why this exists: 0001_booking_service_init (and everything after) assumes the
-- "booking" schema already exists. It did on the shared development database —
...
-- 'schema "booking" does not exist', which meant the repository could not build a
